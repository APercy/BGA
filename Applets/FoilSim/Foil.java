...
public class Foil extends java.applet.Applet {
   ...
   static double g0,q0,ps0,pt0,ts0,rho,rlhum,temf ;
...
//        if (foil == 5) lift = lift * 3.1415926 / 2.0 ; 
     ...
     switch (lunits)  {
       case 0: {                             /* English */
           ...
           in.flt.inl.o5.setText(String.valueOf(filter3(q0))) ;
           in.flt.inl.lo5.setText("Dyn Press lb/ft2") ;
           in.flt.inr.inr2.o2.setText(String.valueOf(filter0(ts0 - 460.))) ;
           in.flt.inr.inr2.lo2.setText("Temp. F") ;
           in.flt.inl.lo3.setText("Dens slug/ft3") ;
        ...
        case 1: {                             /* Metric */
           ...
           in.flt.inl.o5.setText(String.valueOf(filter3(101.3/14.7*q0/144.))) ;
           in.flt.inl.lo5.setText("Dyn Press kPa") ;
           ...
           in.flt.inl.lo3.setText("Dens kg/m3") ;
     ...
     if (planet == 1 || planet == 2) {
        in.flt.inr.inr6.o6.setText(String.valueOf(filter3(rlhum))) ;
     }
...
*/
       ...
       if (planet == 5) {  // Venus - surface conditions
          rgas = 1149. ;                
          gama = 1.29 ;
          rlhum = 0.0 ;
 ...
 // Drag value
     ...
     class Perf extends Panel {
        ...
        Perf (Foil target) {
           ...
           prnt.appendText("FoilSim III 1.5b beta - 4 Sep 13 ") ;
           add(prnt) ;
        }
     }  // Perf
  } // Out 
...
// Labels
 ...
 // zoom in
  ...
  public static void main(String args[]) {
    ...
    f = new Frame("FoilSim III - Airfoil mode - Version 1.5b") ;
    f.add("Center", foil) ;
    f.resize(800, 600);
    f.show() ;
